...
# 【修改点 1】：导入 FreqUNet_SparseView
from models.dbf_unet import FreqUNet_SparseView
from utils import ensure_dir


def build_model(cfg, device):
    # 【修改点 2】：实例化 FreqUNet_SparseView，并传入频率模块相关的参数
    model = FreqUNet_SparseView(
        in_channels=1,
        out_channels=1,
...
'''
python /ibex/user/wangz0r/CS_300_Final_Project/CS_300/DBF-UNet-SV/infer.py \
--config /ibex/user/wangz0r/CS_300_Final_Project/CS_300/DBF-UNet-SV/config/config_exp2_ablation_sparse_view_only.yaml \
--ckpt /ibex/user/wangz0r/CS_300_Final_Project/CS_300/cache/checkpoint/SV_comp__noBH__noW__noTV__ds6__mode1_plain__iter100__rec2048__step0p8__pwr25__noWclip__noWstep__noTVinner/best.pth \
--output_dir /ibex/user/wangz0r/CS_300_Final_Project/CS_300/cache/result/SV_comp__noBH__noW__noTV__ds6__mode1_plain__iter100__rec2048__step0p8__pwr25__noWclip__noWstep__noTVinner
'''
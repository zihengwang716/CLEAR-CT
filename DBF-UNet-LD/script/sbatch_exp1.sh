#!/bin/bash -l
#SBATCH --job-name=300_LD_EXP1          # 任务名称
...
CONFIG_FILE="config_exp1_ablation_low_dose_only.yaml"
CONFIG_PATH="/ibex/user/liuj0s/CS_300/DBF-UNet-LD/config/${CONFIG_FILE}"


python /ibex/user/liuj0s/CS_300/DBF-UNet-LD/train.py --config ${CONFIG_PATH}
